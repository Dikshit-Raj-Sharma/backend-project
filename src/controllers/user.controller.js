...
import { uploadOnCloudinary,deleteFromCloudinary } from "../utils/couldinary.js";
...
const updateUserAvatar = asyncHandler(async (req, res) =>{
    ...
    return res
      .status(200)
      .json(new ApiResponse(200,user,"Use Avatar Updated Successfully"))
})
